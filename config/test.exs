...
config :rs, Rs.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "rs_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :rs, RsWeb.Endpoint,
  ...
  secret_key_base: "s+weQegn/inxlW+1nfxyJGBzhJ+2++jZZfdMkNbL8wdorwDP7i/hiJKoaymVmVJL",
  server: false

# In test we don't send emails
config :rs, Rs.Mailer, adapter: Swoosh.Adapters.Test
